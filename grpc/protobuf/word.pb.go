...
type Response struct {
	...
	Word_Count_ []*Word_Count `protobuf:"bytes,1,rep,name=Word_Count_,json=WordCount,proto3" json:"Word_Count_,omitempty"`
}
...
func (x *Response) GetWord_Count_() []*Word_Count {
	if x != nil {
		return x.Word_Count_
	}
	return nil
}
...
func (x *Word_Count) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Word_Count) ProtoMessage() {}

func (x *Word_Count) ProtoReflect() protoreflect.Message {
	mi := &file_word_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Word_Count.ProtoReflect.Descriptor instead.
func (*Word_Count) Descriptor() ([]byte, []int) {
	return file_word_proto_rawDescGZIP(), []int{2}
}

func (x *Word_Count) GetWord() string {
	if x != nil {
		return x.Word
	}
	return ""
...
func (x *Word_Count) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_word_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x77, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72,
	...
	,
	...
	0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
...
var file_word_proto_goTypes = []interface{}{
	...
	(*Word_Count)(nil), // 2: proto.Word_Count
}
var file_word_proto_depIdxs = []int32{
	2, // 0: proto.Response.Word_Count_:type_name -> proto.Word_Count
	0, // 1: proto.Word.Word_Count:input_type -> proto.Request
	1, // 2: proto.Word.Word_Count:output_type -> proto.Response
