...
type WordClient interface {
	Word_Count(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *wordClient) Word_Count(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Word/Word_Count", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WordServer interface {
	Word_Count(context.Context, *Request) (*Response, error)
...
func (UnimplementedWordServer) Word_Count(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Word_Count not implemented")
}
...
func _Word_Word_Count_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WordServer).Word_Count(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Word/Word_Count",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WordServer).Word_Count(ctx, req.(*Request))
	}
...
var Word_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.Word",
	HandlerType: (*WordServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Word_Count",
			Handler:    _Word_Word_Count_Handler,
		},
	},
